"""
Django settings for activity_log_45066 project.
...
ROOT_URLCONF = 'activity_log_45066.urls'
...
WSGI_APPLICATION = 'activity_log_45066.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "activity_log_45066 API",
    "DESCRIPTION": "API documentation for activity_log_45066 App",
    "VERSION": "v1",
}
